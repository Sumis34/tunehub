...
import { MoonStar, Speaker, Volume2, Wifi } from "lucide-react";
      ...
      {createPortal(
        <>
          ...
          >
            ...
            >
              <div className="flex-1 grid grid-rows-2 grid-cols-3 p-4 gap-4 w-full container mx-auto max-w-md">
                <Button
                  onClick={() => {
                ...
                <Button
                  onClick={() => {
                    navigate({ to: "/app/select-wifi" });
                    close();
                  }}
                >
                  <Wifi className="h-12 w-12 m-auto" />
                </Button>
